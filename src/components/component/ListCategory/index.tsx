...
import { CategoryType, FetchCategoriesResponse, FetchMoviesResponse, MovieType } from '@/src/libs/type';
import { handleFetchCategories } from '@/src/services/category';
import { handleFetchMovies } from '@/src/services/movie';
