...
import MovieIcon from "@/src/assets/icons/ic_baseline-local-movies.png"
import CardMovie from '../CardMovie';
// import { paginate } from '@/libs/helpers/pagonationHelper';
import PaginationButton from '../Base/PaginationButton';
import { CategoryType, ITEMS_PER_PAGE, MovieType } from '@/src/libs/type';
import { handleFetchMovieByID, handleFetchMovies } from '@/src/services/movie';
import { useMovie } from '@/src/hooks/useMoviesContext';
